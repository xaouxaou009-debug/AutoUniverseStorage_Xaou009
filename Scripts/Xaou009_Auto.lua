AutoUniverseStorage = GameMain:NewMod("AutoUniverseStorage")

function AutoUniverseStorage:OnInit()
end

function AutoUniverseStorage:OnEnter()
self.nTotalTime = 0
...
function AutoUniverseStorage:OnStep(nDeltaTime)
...
function AutoUniverseStorage:DoAutoSleeve()
...
function AutoUniverseStorage:FindRemoteStorage()
...
function AutoUniverseStorage:Switch()
